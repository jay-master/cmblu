...
def process_and_save_data():
    ...
    # Extract the original file name without extension for use in output files
    ...
    for segment, group in grouped:
        ...
        # Sort the data by 'freq' column in ascending order
        group = group.sort_values(by='freq').reset_index(drop=True)

        # Generate file name and save
        filename = f"{original_filename}_Segment{segment}_{direction}_{soc}.csv"
