# -*- coding: utf-8 -*-
"""
Created on Wed May 29 13:12:16 2024
...
class PlotApp:
    ...
    def create_widgets(self):
        ...
        self.legend_frame.grid(row=2, column=0, columnspan=3, padx=10, pady=10)
        ...
        self.title_label.grid(row=3, column=0, padx=10, pady=10)
        self.title_entry = tk.Entry(self.root)
        self.title_entry.grid(row=3, column=1, padx=10, pady=10, columnspan=2)

        self.xlabel_label = tk.Label(self.root, text="X-axis Label:")
        self.xlabel_label.grid(row=4, column=0, padx=10, pady=10)
        self.xlabel_entry = tk.Entry(self.root)
        self.xlabel_entry.grid(row=4, column=1, padx=10, pady=10, columnspan=2)

        self.ylabel_label = tk.Label(self.root, text="Y-axis Label:")
        self.ylabel_label.grid(row=5, column=0, padx=10, pady=10)
        self.ylabel_entry = tk.Entry(self.root)
        self.ylabel_entry.grid(row=5, column=1, padx=10, pady=10, columnspan=2)

        self.fontsize_title_label = tk.Label(self.root, text="Title Font Size:")
        self.fontsize_title_label.grid(row=6, column=0, padx=10, pady=10)
        self.fontsize_title_spinbox = tk.Spinbox(self.root, from_=6, to_=20, value=10)
        self.fontsize_title_spinbox.grid(row=6, column=1, padx=10, pady=10, columnspan=2)

        self.fontsize_labels_label = tk.Label(self.root, text="Labels Font Size:")
        self.fontsize_labels_label.grid(row=7, column=0, padx=10, pady=10)
        self.fontsize_labels_spinbox = tk.Spinbox(self.root, from_=6, to_=20, value=10)
        self.fontsize_labels_spinbox.grid(row=7, column=1, padx=10, pady=10, columnspan=2)

        self.fontsize_legend_label = tk.Label(self.root, text="Legend Font Size:")
        self.fontsize_legend_label.grid(row=8, column=0, padx=10, pady=10)
        self.fontsize_legend_spinbox = tk.Spinbox(self.root, from_=6, to_=20, value=10)
        self.fontsize_legend_spinbox.grid(row=8, column=1, padx=10, pady=10, columnspan=2)

        self.fontsize_ticks_label = tk.Label(self.root, text="Ticks Font Size:")
        self.fontsize_ticks_label.grid(row=9, column=0, padx=10, pady=10)
        self.fontsize_ticks_spinbox = tk.Spinbox(self.root, from_=6, to_=20, value=10)
        self.fontsize_ticks_spinbox.grid(row=9, column=1, padx=10, pady=10, columnspan=2)

        self.legend_var = tk.BooleanVar()
        self.legend_checkbutton = tk.Checkbutton(self.root, text="Show Legend", variable=self.legend_var)
        self.legend_checkbutton.grid(row=10, column=0, padx=10, pady=10)

        self.grid_var = tk.BooleanVar()
        self.grid_checkbutton = tk.Checkbutton(self.root, text="Show Grid", variable=self.grid_var)
        self.grid_checkbutton.grid(row=10, column=1, padx=10, pady=10)

        self.plot_button = tk.Button(self.root, text="Plot", command=self.plot_data)
        self.plot_button.grid(row=11, column=0, columnspan=3, padx=10, pady=10)
