# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 18:00:09 2024
...
class PlotApp:
    ...
    def create_widgets(self):
        ...
        self.plot_button.grid(row=14, column=0, columnspan=4, padx=5, pady=5)
    ...
    def plot_data(self):
        ...
        # Get the width and height from the entries or set default values
        try:
