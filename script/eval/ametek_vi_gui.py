...
class PlotApp:
    ...
    def create_widgets(self):
        ...
        self.plot_type_combobox = ttk.Combobox(self.root, values=["Nyquist", "Elapsed Time vs Voltage", "Elapsed Time vs Current"])
    ...
    def plot_data(self):
        ...
        if self.color_chosen:
            ...
            for i, segment in enumerate(selected_segments):
                ...
                elif plot_type == "Elapsed Time vs Voltage":
                    ax.plot(segment_data['Elapsed Time (s)'], segment_data['Potential (V)'],
                            label=legend_text,
                            linestyle=line_style,
                            linewidth=1,
                            color=line_color)
                    scatter = ax.scatter(segment_data['Elapsed Time (s)'], segment_data['Potential (V)'],
                                         marker='o', s=20, color=line_color)
                elif plot_type == "Elapsed Time vs Current":
                    ax.plot(segment_data['Elapsed Time (s)'], segment_data['Current (A)'],
                            label=legend_text,
                            linestyle=line_style,
                            linewidth=1,
                            color=line_color)
                    scatter = ax.scatter(segment_data['Elapsed Time (s)'], segment_data['Current (A)'],
                                         marker='o', s=20, color=line_color)
                ...
                def on_add(sel):
                    if plot_type == "Nyquist":
                        ...
                        sel.annotation.set_text(f"{segment_data.iloc[sel.target.index]['Elapsed Time (s)']:.2f}")
