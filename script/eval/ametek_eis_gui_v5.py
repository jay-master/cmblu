# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 13:53:03 2024
...
class PlotApp:
    ...
    def create_widgets(self):
        ...
        # Increase the height of the segment listbox
        self.segment_listbox = tk.Listbox(self.segment_frame, selectmode=tk.MULTIPLE, yscrollcommand=self.segment_scrollbar.set, height=10)
        ...
        # Increase the height of the legend canvas
    ...
    def plot_data(self):
        ...
        if self.color_chosen:
            ...
            for i, segment in enumerate(selected_segments):
                ...
                line_color = self.adjust_lightness(base_color, color_factor, invert=invert_colors)
